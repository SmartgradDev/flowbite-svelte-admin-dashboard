<script lang="ts">
	...
	// Set payment_type to sbs-workshop for this specific route
	const payment_type = 'sbs-workshop';
	...
	// Send SBS Workshop emails
	const sendSbsWorkshopEmails = async () => {
		...
		try {
			...
			const response = await axios.post(
				`${apiUrl}/admin/sendSbsWorkshopEmails`,
...
<MetaTag
	title="Custom Payment - SBS Workshop Q126"
	description="Manage custom payments for SBS Workshop Q126"
/>
...
<main class="relative h-full w-full overflow-y-auto bg-gray-50 p-4 dark:bg-gray-900">
	<div class="mx-auto max-w-screen-2xl">
		<Breadcrumb class="mb-5">
			...
			<BreadcrumbItem>Custom Payment - SBS Workshop Q126</BreadcrumbItem>
		</Breadcrumb>
		<Heading tag="h1" class="text-xl font-semibold text-gray-900 dark:text-white sm:text-2xl">
			Custom Payment - SBS Workshop Q126
		</Heading>
		<p class="mb-6 text-gray-500 dark:text-gray-400">
			Manage custom payments for SBS Workshop Q126
		</p>
		...
		<div class="relative overflow-hidden bg-white shadow-md dark:bg-gray-800 sm:rounded-lg">
			<Toolbar embedded class="w-full py-4 text-left text-gray-500 dark:text-gray-400">
				<ToolbarGroup>
					...
					<Button 
						on:click={sendSbsWorkshopEmails} 
					...
					>
						...
						{#if emailSending}
							Sending Emails...
						{:else}
							Send SBS Workshop Emails ({selectedPayments.length})
						{/if}
					</Button>
				</ToolbarGroup>
				<ToolbarGroup>
					...
					<div class="flex">
						...
						<div class="ml-3">
							<p class="text-sm text-blue-700 dark:text-blue-200">
								...
								Click "Send SBS Workshop Emails" to notify these users about their verified registration.
							</p>
						</div>
					</div>
				</div>
