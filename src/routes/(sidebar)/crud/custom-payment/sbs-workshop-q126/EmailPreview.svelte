<script lang="ts">
	...
	const createSbsWorkshopInvitationTemplate = (name: string) => {
		return `
			<!DOCTYPE html>
			<html lang="en">
			<head>
				...
				<title>Registration Verified - SBS Workshop Q126 Invitation</title>
				<style>
					body {
			...
			<body>
				<div class="container">
					...
					<div class="message">
						...
						<div class="highlight">
							<p><strong>Great news!</strong> Your registration has been successfully verified, and we're excited to invite you to join our SBS Workshop Q126.</p>
						</div>
						
						<p>Our SBS Workshop Q126 is designed to help you with:</p>
						<ul>
					...
					<div class="cta-container">
						<a href="${LOGIN_URL}" class="cta-button primary-button">
							🚀 Login to Join SBS Workshop Q126
						</a>
						<br>
	...
	$: sampleEmailHTML = createSbsWorkshopInvitationTemplate('[Student Name]');
</script>
	...
	<div class="flex flex-col space-y-6">
		<div class="flex items-center space-x-2">
			...
			<h3 class="text-xl font-medium text-gray-900 dark:text-white">
				Email Preview - SBS Workshop Q126 Invitation
			</h3>
		</div>
			...
			<div class="flex">
				...
				<div class="ml-3">
					<p class="text-sm text-blue-700 dark:text-blue-200">
						<strong>Subject:</strong> Registration Verified - Join SBS Workshop Q126! 🚀
					</p>
