<script lang="ts">
	...
	const createHurdcoWorkshopInvitationTemplate = (name: string) => {
		return `
			<!DOCTYPE html>
			<html lang="en">
			<head>
				...
				<title>Registration Verified - HURDCO Workshop Invitation</title>
				<style>
					body {
			...
			<body>
				<div class="container">
					...
					<div class="message">
						...
						<div class="highlight">
							<p><strong>Great news!</strong> Your registration has been successfully verified, and we're excited to invite you to join our HURDCO Workshop.</p>
						</div>
						
						<p>Our HURDCO Workshop is designed to help you with:</p>
						<ul>
	...
	$: sampleEmailHTML = createHurdcoWorkshopInvitationTemplate('[Student Name]');
</script>
	...
	<div class="flex flex-col space-y-6">
		<div class="flex items-center space-x-2">
			...
			<h3 class="text-xl font-medium text-gray-900 dark:text-white">
				Email Preview - HURDCO Workshop Invitation
			</h3>
		</div>
			...
			<div class="flex">
				...
				<div class="ml-3">
					<p class="text-sm text-blue-700 dark:text-blue-200">
						<strong>Subject:</strong> Registration Verified - Join HURDCO Workshop! 🚀
					</p>
